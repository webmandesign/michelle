		...
		<div class="site-info">
			<span class="site-info-item">
				<a href="#top" class="back-to-top">
					<svg class="svg-icon" width="3em" aria-hidden="true" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><polygon fill="#231F20" points="8,4.6 1.3,11.3 2.7,12.7 8,7.4 13.3,12.7 14.7,11.3 "/></svg>
