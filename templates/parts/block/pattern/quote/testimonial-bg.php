...
<!-- wp:cover {"url":"<?php echo esc_url_raw( $image1 ); ?>","id":999991,"hasParallax":true,"dimRatio":90,"align":"full","className":"is-style-no-padding","style":{"spacing":{"padding":{"top":"150px","bottom":"120px"}}}} -->
<div class="wp-block-cover alignfull has-background-dim-90 has-background-dim has-parallax is-style-no-padding" style="padding-top:150px;padding-bottom:120px;background-image:url(<?php echo esc_url_raw( $image1 ); ?>)"><div class="wp-block-cover__inner-container"><!-- wp:heading {"className":"is-style-screen-reader-text"} -->
